...
plantestsuite(
    ...
    ["PYTHON={0!s}".format(python), os.path.join(bbdir, "demote-saveddb.sh"),
     '$PREFIX_ABS/demote', configuration])
plantestsuite(
    "samba4.blackbox.dbcheck.alpha13", "none",
    ["PYTHON={0!s}".format(python), os.path.join(bbdir, "dbcheck-oldrelease.sh"),
