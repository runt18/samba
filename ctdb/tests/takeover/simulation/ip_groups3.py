...
addresses1 = ['192.168.1.{0:d}'.format(n) for n in range(1, 41)]
addresses2 = ['192.168.2.{0:d}'.format(n) for n in range(1, 21)]
addresses3 = ['192.168.3.{0:d}'.format(n) for n in range(1, 11)]
addresses4 = ['192.168.4.{0:d}'.format(n) for n in range(1, 11)]
